...
export const AddDocumentModal: React.FC<AddDocumentModalProps> = ({
  ...
  const [category, setCategory] = useState<CategoryType>('Administración');
  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    const bgColors: Record<FileType, { bg: string; text: string }> = {
      excel: { bg: 'bg-emerald-50', text: 'text-emerald-700' },
      word: { bg: 'bg-blue-50', text: 'text-blue-700' },
      pdf: { bg: 'bg-amber-50', text: 'text-amber-700' },
      form: { bg: 'bg-purple-50', text: 'text-purple-700' },
      drive: { bg: 'bg-slate-100', text: 'text-[#234156]' },
    };
    ...
    const newDoc: FormatoDocumento = {
      ...
      iconBgColor: bgColors[fileType]?.bg || 'bg-amber-100',
      iconTextColor: bgColors[fileType]?.text || 'text-[#234156]',
      downloadsCount: 0,
    };
        ...
        <form onSubmit={handleSubmit} className="space-y-4 text-xs">
          <div>
            ...
            <input
              type="text"
              required
              placeholder="Ej: Formato de Solicitud de Viáticos 2026"
              value={title}
          ...
          <div className="grid grid-cols-2 gap-4">
            <div>
              ...
              >
                ...
                <option value="Formatos de Viáticos">Formatos de Viáticos</option>
                <option value="Leyes y Reglamentos">Leyes y Reglamentos</option>
                <option value="Redacción y Estilo">Redacción y Estilo</option>
                <option value="Salud y Seguridad (SST)">Salud y Seguridad (SST)</option>
                <option value="Proyectos y Becas">Proyectos y Becas</option>
              </select>
            </div>
            ...
            <div>
              ...
              <select
                ...
                className="w-full px-3.5 py-2.5 rounded-xl border border-slate-300 focus:ring-2 focus:ring-[#234156] font-medium"
              >
                <option value="excel">Excel / Plantilla de Cálculo</option>
                <option value="word">Documento de Texto (Word/Docs)</option>
                <option value="pdf">Documento PDF Oficial</option>
                <option value="form">Formulario (Google Forms)</option>
          ...
          <div>
            ...
            <textarea
              rows={3}
              placeholder="Describa para qué sirve este formato y quiénes deben diligenciarlo..."
              value={description}
